...
export default function MagnifierIcon({ fill, duration, transition }: IconProps) {
  return (
    <svg className={`${fill} ${duration} ${transition}`} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
